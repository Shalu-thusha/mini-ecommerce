...
//add to cart function 
    function addToCart(){
        const itemExist = cartItems.find((item)=> item.product._id == product._id)//one product 1 cart add function not more than 1 cart 
        if(!itemExist){
                const newItem = {product,qty};
                setCartItems((state)=> [...state,newItem]);
                toast.success("Cart Item Add Successfully!")
                            ...
                            <div className="row f-flex justify-content-around">
                                ...
                                <div className="col-12 col-lg-5 mt-5">
                                    ...
                                    <div className="rating-outer">
                                        <div className="rating-inner" style={{ width: `${Number(product.ratings) / 5 * 100}%` }}></div>
                                    </div>
